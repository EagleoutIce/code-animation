...
% TODO: make store automatically detect handout and anim!
% TODO: \+ etc... for adding
...
\AnimateCode{onslide={%
   ...
   *\Line{4}\Comment{Walter}\Location{end}\StoreAnimationTo\Walter\StoreHandoutTo\WalterHandout,% komplett frei :D
   3, .4
},handout={5/2,\WalterHandout/3},first slide=2}
\begin{minted}{java}
...
\end{minted}
\endAnimateCode
Walter kommt (nur bei Animationen natürlich) auf Slide \Walter. Sein Handout-Mapping ist Folie \WalterHandout. % TODO: improve handling of symbolic stuff
\end{frame}
